...
const TransactionList = () => {
  ...
  const transactions = [
    { name: "Annette Block", date: "20 Feb 2025 AT 10:00 AM", type: "Income", amount: "$948.55", category: "Salary", isPrinting: false },
    { name: "Wade Warren", date: "10 May 2025 AT 10:00 PM", type: "Income", amount: "$328.85", category: "Salary", isPrinting: false },
    { name: "Jacks Cooper", date: "20 Aug 2025 AT 03:00 AM", type: "Expense", amount: "$446.61", category: "Food", isPrinting: true },
    { name: "Henry Roberts", date: "24 Jan 2025 AT 12:00 PM", type: "Income", amount: "$778.35", category: "Salary", isPrinting: false },
    { name: "Kristin Weston", date: "18 Dec 2025 AT 05:00 AM", type: "Expense", amount: "$302.87", category: "Food", isPrinting: true },
    { name: "Bestie Cooper", date: "30 Sep 2025 AT 06:00 PM", type: "Income", amount: "$106.58", category: "Salary", isPrinting: false },
    { name: "Theresa Webb", date: "28 Mar 2025 AT 10:00 AM", type: "Expense", amount: "$219.78", category: "Food", isPrinting: true },
    { name: "Ariene McCoy", date: "08 Nov 2025 AT 03:00 PM", type: "Expense", amount: "$105.55", category: "Food", isPrinting: true },
    { name: "Jackson Toper", date: "12 Oct 2025 AT 03:00 AM", type: "Income", amount: "$210.45", category: "Salary", isPrinting: false },
  ];
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-100">
          <thead className="bg-gray-50">
            <tr>
              {["Merchant", "Transaction Date", "Type", "Category", "Amount", "Actions"].map(
                (col) => (
                  <th
                    key={col}
                    scope="col"
          ...
          <tbody className="divide-y divide-gray-100">
            {transactions.map((transaction, idx) => (
              <tr key={idx} className="hover:bg-gray-50 transition-colors">
                ...
                >
                  {transaction.type === "Income" ? <MdAdd size={14} /> : <FaMinus size={12} />}
                  {transaction.amount}
                </td>
                <td className="px-4 md:px-6 py-3 md:py-4 whitespace-nowrap">
